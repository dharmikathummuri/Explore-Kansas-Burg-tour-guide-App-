...
function start()
{
	...
	document.getElementById("heroesButtonId").addEventListener("click",function(){
		table=document.getElementById("americanTableId");
	...
	document.getElementById("fitterButtonId").addEventListener("click",function(){
		table=document.getElementById("americanTableId");
		table.style.visibility="hidden";
		tableHidden= true;
		if(table.style.visibility=="hidden")
	...
	document.getElementById("thirdStreetButtonId").addEventListener("click",function(){
		table=document.getElementById("americanTableId");
		table.style.visibility="hidden";
		tableHidden= true;
		if(table.style.visibility=="hidden")
...
function deleteRows()
{
	var elmtTable = document.getElementById('americanTableId');
...
function getXMLDataHeroes()
{
	...
	xhr.addEventListener("readystatechange",function(){
		...
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("heroesRestaurant");
		...
		document.getElementById("americanTableId").appendChild(tableRow);
		document.getElementById("americanTableId").appendChild(tableRow1);
		document.getElementById("americanTableId").appendChild(tableRow2);
		document.getElementById("americanTableId").appendChild(tableRow3);
		document.getElementById("americanTableId").appendChild(tableRow4);
		document.getElementById("americanTableId").appendChild(tableRow5);
	...
	xhr.open("get","americanFood.xml",true);
	xhr.send(null);
	
}

function getXMLDataFitter()
{
		xhr= new XMLHttpRequest;
		xhr.addEventListener("readystatechange",function(){
		//anonymous function for displaying ruchi restaurant details
		if(xhr.readyState==4 && xhr.status==200 && xhr.responseXML)
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("fitterRestaurant");
			for(var i=0;i<restaurantArray.length;i++)
			{
...
function getXMLDataThird()
{
		...
		if(xhr.readyState==4 && xhr.status==200 && xhr.responseXML)
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("thirdStreetRestaurant");
			for(var i=0;i<restaurantArray.length;i++)
			{
