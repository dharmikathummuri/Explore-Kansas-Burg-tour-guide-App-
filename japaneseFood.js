...
function start()
{
	...
	document.getElementById("sikiButtonId").addEventListener("click",function(){
		table=document.getElementById("japaneseTableId");
	...
	document.getElementById("naraButtonId").addEventListener("click",function(){
		table=document.getElementById("japaneseTableId");
		table.style.visibility="hidden";
		tableHidden= true;
		if(table.style.visibility=="hidden")
	...
	document.getElementById("friendsButtonId").addEventListener("click",function(){
		table=document.getElementById("japaneseTableId");
		table.style.visibility="hidden";
		tableHidden= true;
		if(table.style.visibility=="hidden")
	...
	document.getElementById("KCSushiButtonId").addEventListener("click",function(){
		table=document.getElementById("japaneseTableId");
		table.style.visibility="hidden";
		tableHidden= true;
		if(table.style.visibility=="hidden")
...
function deleteRows()
{
	var elmtTable = document.getElementById('japaneseTableId');
...
function getXMLDataSiki()
{
	...
	xhr.addEventListener("readystatechange",function(){
		...
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("sikiRestaurant");
		...
		document.getElementById("japaneseTableId").appendChild(tableRow);
		document.getElementById("japaneseTableId").appendChild(tableRow1);
		document.getElementById("japaneseTableId").appendChild(tableRow2);
		document.getElementById("japaneseTableId").appendChild(tableRow3);
		document.getElementById("japaneseTableId").appendChild(tableRow4);
		document.getElementById("japaneseTableId").appendChild(tableRow5);
	...
	xhr.open("get","japaneseFood.xml",true);
	xhr.send(null);
	
}

function getXMLDataNara()
{
		xhr= new XMLHttpRequest;
		xhr.addEventListener("readystatechange",function(){
		//anonymous function for displaying ruchi restaurant details
		if(xhr.readyState==4 && xhr.status==200 && xhr.responseXML)
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("naraRestaurant");
			for(var i=0;i<restaurantArray.length;i++)
			{
...
function getXMLDataFriends()
{
		...
		if(xhr.readyState==4 && xhr.status==200 && xhr.responseXML)
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("friendsRestaurant");
			for(var i=0;i<restaurantArray.length;i++)
			{
...
function getXMLDataKCSushi()
{
		...
		if(xhr.readyState==4 && xhr.status==200 && xhr.responseXML)
		{
			restaurantArray= xhr.responseXML.getElementsByTagName("kcSushiRestaurant");
			for(var i=0;i<restaurantArray.length;i++)
			{
